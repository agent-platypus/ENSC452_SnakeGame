...
#define BUTTON_PLAY_PIN    XPAR_GPIO_1_DEVICE_ID
#define BUTTON_STOP_PIN    XPAR_GPIO_1_DEVICE_ID
#define BUTTON_VOL_UP_PIN  XPAR_GPIO_1_DEVICE_ID
#define BUTTON_VOL_DOWN_PIN XPAR_GPIO_1_DEVICE_ID
#define BUTTON_NEXT_PIN    XPAR_GPIO_1_DEVICE_ID
#define BUTTON_PREV_PIN    XPAR_GPIO_1_DEVICE_ID
/* ---------------------------------------------------------------------------- *
