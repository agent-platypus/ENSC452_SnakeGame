...
extern bool isInvincible; // Is the invincible power up active?
extern int invincible_duration; // Remaining duration of invincible power up (in timer interrupts)
